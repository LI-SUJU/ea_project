...
def optimize(params):
    ...
    print(np.round(result,3), np.round(max(values), 3), params[0], params[1], params[2])

    if result >= 3.5:
        with open('es_1p.csv', 'a') as file:
...
if __name__ == "__main__":
    ...
    param_space = [
        Real(0.01, 1, name='sigma_init'),
        Integer(2, 200, name='mu'),
        Integer(3, 200, name='lambda')
    ]
