...
def tune_hyperparameters():
    ...
    def objective(trial):
        ...
        pop_size = trial.suggest_int("population_size", 1, 100, step=1)
        ...
        fitness_F18 = studentnumber1_studentnumber2_GA(F18, 50, 5000, pop_size, mutation_rate, crossover_rate, num_elitism=1)
        fitness_F23 = studentnumber1_studentnumber2_GA(F23, 49, 5000, pop_size, mutation_rate, crossover_rate, num_elitism=1)
...
if __name__ == "__main__":
    ...
    algorithm_name = "Dynamic Elitist GA"
    ...
    for i in range(20):
        ...
        best_fitness = studentnumber1_studentnumber2_GA(
            F18, 50, 5000, best_params["population_size"], best_params["mutation_rate"], best_params["crossover_rate"], num_elitism=1
        )
    ...
    for i in range(20):
        ...
        best_fitness = studentnumber1_studentnumber2_GA(
            F23, 49, 5000, best_params["population_size"], best_params["mutation_rate"], best_params["crossover_rate"], num_elitism=1
        )
        print(f"    Best fitness achieved in this run: {best_fitness}")
        F23.reset()
    _logger_F23.close()
